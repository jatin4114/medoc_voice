...
7. Prescribing Doctor: [Leave blank for doctor to fill in]
      ...
      final chat = model.startChat(history: [
        Content.multi([
          TextPart('Input: $_transcription'), // Pass the transcription input
        ]),
        // Content.model([
        //   TextPart('1. isme ayega apna history reuse k liye'), // You might want to adjust this initial model response
        // ]),
      ]);
